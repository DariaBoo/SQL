...
public interface CourseDAO {
    ...
    /**
     * The method returns list of student's courses, selecting by studentID from the database
     * @author Bogush Daria
     * @param studentID
     * @return List<Course>
     * @see Course
    ...
    /**
     * The method remove student from his/her courses by studentID and courseID from the database
     * @author Bogush Daria
     * @param studentID
     * @param courseID
